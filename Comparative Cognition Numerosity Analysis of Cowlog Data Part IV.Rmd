...
df.sum$binned_shuttlebox_proportion_of_time_on_correct_side_during_gaps_slope_slope_across_presentations[i]<- gap_prop_binned_slope
df.sum$binned_shuttlebox_proportion_of_time_on_correct_side_during_stimulus_slope_slope_across_presentations[i]<- stim_prop_binned_slope
...
df.sum.23$twentythree_filtered_binned_shuttlebox_proportion_of_time_on_correct_side_during_gaps_slope_slope_across_presentations[i]<- gap_prop_binned_slope
df.sum.23$twentythree_filtered_binned_shuttlebox_proportion_of_time_on_correct_side_during_stimulus_slope_slope_across_presentations[i]<- stim_prop_binned_slope
...
df.sum<- full_join(df.sum,df.sum.23, by = 'fish_name')
...
write_csv(df.sum, "shuttlebox_data_april_23_2018.csv")
